...
# SPECIFICATION: test speed and accuracy of base classifier, ensemble classifier and Random forest classifier
...
#--> add your Python code here
   ...
   total_predictions = 0
   for i, testSample in enumerate(dbTest):
      if testSample[-1] == classVotes[i].index(max(classVotes[i])):
         accurate_predictions += 1
      total_predictions += 1
